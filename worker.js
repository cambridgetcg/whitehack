...
<meta name="description" content="Preserved browser demo of whitehack's original eight JS/TS and Solidity checks. The canonical v0.5 CLI/API runs 42 checks." />
<style>
  :root {
    --ink: #0a0a0b;
    --panel: #141416;
...
<section class="hero">
  <div class="wrap">
    ...
    <p class="sub">This preserved demo runs the original eight JS/TS and Solidity checks entirely in this page — no server or upload. It does not run the canonical v0.5 CLI/API's 42-check protocol and crypto-awareness pack.</p>
...
// The canonical v0.5 CLI/API has 42 checks; this demo is intentionally not parity.
