...
const GUARD = /\b(throw|console\.|logger?\.|report\(|rethrow|process\.exit|captureException|Sentry|warn\(|error\(|logFor\w*\(|logError\(|logBridgeSkip\(|logEvent\(|logWarn\(|logInfo\(|logDebug\(|onDebug\(|onDone\(|onWarn\(|setError\(|onError\()/
