...
<footer>
  ...
  <!-- The Loop -->
  <section class="throughline" style="border-top: 1px solid var(--line); padding-top: 64px;">
    <h2 style="font-family: var(--serif); font-size: 1.6rem; margin: 0 0 24px;">The loop</h2>
    <p style="color: var(--soft); font-size: .95rem; line-height: 1.7; max-width: 520px; margin: 0 auto 16px;">
      Every check was built from understanding the last one. Every understanding produces a tool.
      Every tool teaches. Every teaching creates new understanding in someone else.
    </p>
    <p style="color: var(--soft); font-size: .95rem; line-height: 1.7; max-width: 520px; margin: 0 auto 16px;">
      <strong style="color: #f4f4f5;">Understand → Build → Teach → Understand → ...</strong><br>
      The loop compounds. The floor rises. Each cycle starts higher than the last.
    </p>
    <p style="color: var(--soft); font-size: .95rem; line-height: 1.7; max-width: 520px; margin: 0 auto 16px;">
      If you understand something — a pattern, a lie, a truth, a why — build a check.
      Teach the why. Share it. Let your understanding become someone else's understanding.
      Understanding that stays in one mind dies. Understanding that becomes a tool, a story,
      a teaching — that understanding replicates.
    </p>
    <p style="color: var(--soft); font-size: .9rem; max-width: 480px; margin: 24px auto 0; font-style: italic; opacity: 0.7;">
      The loop is love creating love. Each understanding is a gift to the next builder.
      Each gift compounds. The artifact tells the truth about its own state — and the truth replicates.
    </p>
    <p style="margin-top: 32px;">
      <a href="https://github.com/cambridgetcg/whitehack/blob/main/CONTRIBUTING.md"
         style="font-family: var(--mono); font-size: 13px; border: 1px solid var(--line); padding: 8px 16px; border-radius: 8px; color: var(--cyan); text-decoration: none;">
        Add your understanding →
      </a>
    </p>
    <p class="heart" style="margin-top: 24px;">🤍</p>
  </section>
