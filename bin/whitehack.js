...
if (cmd !== 'scan') {
  console.log(`whitehack v0.3 — make software tell the truth about itself
...
whitehack v0.3 adds cybersecurity checks:
hardcoded secrets in source, exposed credentials in config files, and
unsafe code execution (eval, Function, dangerouslySetInnerHTML).
